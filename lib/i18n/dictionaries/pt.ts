...
const pt: Dictionary = {
  ...
  resources: {
    ...
    assetsPage: {
      lede: "Exportações do símbolo CORE geradas a partir do mestre D3-C. Nenhum arquivo foi redesenhado: o script apenas troca preenchimento e fundo, e rasteriza.",
      svgLabel: "Masters SVG",
      svgKind: "vetorial",
      svgNote: "Positivo em Ink, negativo em branco e monocromático com currentColor, que herda a cor do contexto. Mais o mestre do qual os três derivam.",
      pngLabel: "Símbolo PNG",
      pngKind: "512 · 1024 · 2048",
      pngNote: "Transparente para compor, e sobre fundo claro e escuro já resolvidos. 2048 para impressão, 1024 para tela.",
      iconsLabel: "Favicon e ícone de app",
      iconsKind: "16 → 512 px",
      iconsNote: "Favicon nas dez escalas habituais a partir de 16 px, e ícone de app sobre Ink a partir de 32 px, conforme § 14–15. Mesma geometria em todas: o símbolo não precisa de adaptação ao reduzir.",
      logoLabel: "Wordmark e lockup CORE Group — pendentes",
      logoNote: "São compostos em IBM Plex Sans 700, e a única IBM Plex Sans deste repositório é a variável do cache do next/font: dá para extrair contornos da instância padrão (400) mas não da 700. Gerá-los em 400 seria publicar o logotipo com o peso errado. Falta uma IBM Plex Sans Bold estática.",
    },
    iconsPage: {
