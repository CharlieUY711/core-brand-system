...
const pt: Dictionary = {
  ...
  home: {
    ...
    corporateModelLede: "A Charlie define. A CORE orquestra e executa. As entidades e operações — ODDY (com OnDemand), COMITA, FACILIA — tocam o negócio.",
  },
  architecture: {
    metaTitle: "Arquitetura Corporativa",
    sectionTitle: "Arquitetura Corporativa",
    lede: "A marca define a aparência da CORE. A Arquitetura Corporativa define como o ecossistema está organizado e quem faz o quê — as duas coisas nunca se misturam. A Charlie define a visão; a CORE é o Business Operating System que orquestra e executa; ODDY (com sua subsidiária OnDemand), COMITA e FACILIA são as entidades que tocam o negócio.",
    ruleText: "A Charlie define. A CORE orquestra e executa. A ODDY opera logística no território doméstico e é a controladora da OnDemand, que opera logística de zona franca e internacional. A COMITA comercializa bens; a FACILIA presta serviços — nunca a função uma da outra. A ODDY nunca é controladora da CORE.",
