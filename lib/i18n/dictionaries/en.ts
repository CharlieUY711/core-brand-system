...
const en: Dictionary = {
  ...
  resources: {
    ...
    assetsPage: {
      lede: "CORE symbol exports generated from the D3-C master. No file was redrawn: the script only changes fill and ground, then rasterizes.",
      svgLabel: "SVG masters",
      svgKind: "vector",
      svgNote: "Positive in Ink, negative in white, and monochrome using currentColor, which inherits the surrounding color. Plus the master the three derive from.",
      pngLabel: "Symbol PNG",
      pngKind: "512 · 1024 · 2048",
      pngNote: "Transparent for compositing, plus light and dark grounds already resolved. 2048 for print, 1024 for screen.",
      iconsLabel: "Favicon and app icon",
      iconsKind: "16 → 512 px",
      iconsNote: "Favicon at the ten usual scales from 16 px, and app icon on Ink from 32 px, per § 14–15. Same geometry throughout: the symbol needs no adaptation as it shrinks.",
      logoLabel: "Wordmark and CORE Group lockup — pending",
      logoNote: "Both are set in IBM Plex Sans 700, and the only IBM Plex Sans in this repository is the variable one from the next/font cache: outlines can be extracted from its default instance (400) but not from 700. Generating them at 400 would publish the logotype at the wrong weight. A static IBM Plex Sans Bold is missing.",
    },
    iconsPage: {
