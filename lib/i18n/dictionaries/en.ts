...
const en: Dictionary = {
  ...
  home: {
    ...
    corporateModelLede: "Charlie defines. CORE orchestrates and executes. The entities and operations — ODDY (with OnDemand), COMITA, FACILIA — carry out the business.",
  },
  architecture: {
    metaTitle: "Corporate Architecture",
    sectionTitle: "Corporate Architecture",
    lede: "Brand defines how CORE looks. Corporate Architecture defines how the ecosystem is organized and who does what — the two are never mixed. Charlie defines the vision; CORE is the Business Operating System that orchestrates and executes; ODDY (with its subsidiary OnDemand), COMITA and FACILIA are the entities that carry out the business.",
    ruleText: "Charlie defines. CORE orchestrates and executes. ODDY operates territory logistics and is the parent of OnDemand, which operates free-trade-zone and international logistics. COMITA trades goods; FACILIA delivers services. ODDY is never a parent of CORE.",
